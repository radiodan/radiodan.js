...
var subject = require(libDir + '/player/mpd/config');
...
describe('mpdConfig', function (){
  ...
  it('generates a config file populated by supplied object', function (done) {
    var mpdConfig = subject.create(this.configObject, [6600, 6601]);
  ...
  it('assigns ports', function(done) {
    var firstConfig  = subject.create({player: 'mpd'}, [6600]),
        secondConfig = subject.create({player: 'mpd'}, [6601]),
  ...
  it('assigns HTTP port', function(done) {
    ...
    var mpdConfig = subject.create(config, [null, 8000]),
  ...
  it('generates a platform-specific boolean key', function(done) {
    ...
    var mpdConfig = subject.create(config, []);
    var built = mpdConfig.build();
  ...
  it('writes config to a generated path', function (done) {
    var mpdConfig = subject.create(this.configObject, [0, 1]),
